...
const eventosProximos = [
  {
    ...
    categoria: "Workshop",
    imagem: "/images/workshop.jpeg?height=300&width=500",
    vagas: 30,
    inscritos: 18,
  },
  {
    ...
    descricao:
      "Discussão sobre práticas sustentáveis e como implementá-las em cooperativas e empresas parceiras.",
    categoria: "Seminário",
    imagem: "/images/seminario.png?height=300&width=500",
    vagas: 100,
    inscritos: 65,
  },
  {
    ...
    descricao:
      "Encontro para networking e troca de experiências entre cooperativas da região sudeste.",
    categoria: "Networking",
    imagem: "/images/encontro.png?height=300&width=500",
    vagas: 50,
    inscritos: 42,
  },
];
...
const eventosPastEvents = [
  {
    ...
    local: "Sede da Cooperativa, São Paulo",
    descricao:
      "Assembleia para apresentação de resultados e planejamento estratégico para o próximo ano.",
    categoria: "Assembleia",
    imagem: "/images/assembleia.png?height=300&width=500",
    participantes: 120,
  },
  {
    id: 102,
    ...
    descricao:
      "Workshop focado no desenvolvimento de habilidades de liderança no contexto cooperativista.",
    categoria: "Workshop",
    imagem: "/images/lideranca.jpg?height=300&width=500",
    participantes: 35,
  },
  {
    id: 103,
    ...
    local: "Centro de Convenções, São Paulo",
    descricao:
      "Apresentação de soluções tecnológicas específicas para o setor cooperativista.",
    categoria: "Seminário",
    imagem: "/images/reuniao.jpg?height=300&width=500",
    participantes: 85,
  },
];
...
export default function EventosPage() {
  ...
  const eventosProximosFiltrados = filtrarEventosPorBusca(
    filtrarEventosPorCategoria(eventosProximos)
  );
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 py-12 mb-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Confira nossa agenda de eventos, workshops, cursos e encontros.
            Participe e amplie sua rede de contatos e conhecimentos.
          </p>
        </div>
      </div>
        ...
        <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="relative h-64 lg:h-auto">
              <Image
                src="/images/feira.webp?height=600&width=800"
            ...
            <div className="p-8">
              <CardTitle className="text-2xl mb-2">
                Feira de Produtos Cooperativos
              </CardTitle>
              <div className="flex flex-wrap gap-2 mb-4">
                <Badge variant="outline" className="flex items-center gap-1">
                  <CalendarIcon className="h-3 w-3" />
                  {format(new Date(2025, 4, 25), "dd 'de' MMMM 'de' yyyy", {
                    locale: ptBR,
                  })}
                </Badge>
                <Badge variant="outline" className="flex items-center gap-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Exposição e venda de produtos desenvolvidos por cooperativas de
                todo o país, com programação cultural, palestras, oficinas e
                atividades para toda a família. Uma oportunidade única para
                conhecer o trabalho de diversas cooperativas e fortalecer a
                economia solidária.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm">
              <Calendar
                ...
                modifiersClassNames={{
                  hasEvent:
                    "bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 font-bold",
                }}
              />
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">
                {date
                  ? `Eventos em ${format(date, "dd 'de' MMMM 'de' yyyy", {
                      locale: ptBR,
                    })}`
                  : "Selecione uma data"}
              </h3>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start gap-4">
                          <div className="relative h-16 w-16 flex-shrink-0 rounded-md overflow-hidden">
                            <Image
                              src={evento.imagem || "/images/feira.webp.svg"}
                              alt={evento.titulo}
                              fill
                              className="object-cover"
                            />
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4 text-white">
                      ...
                      <p className="text-sm text-white/80">
                        {format(evento.data, "dd 'de' MMMM 'de' yyyy", {
                          locale: ptBR,
                        })}
                      </p>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">
                Receba Atualizações de Eventos
              </h2>
              <p className="text-gray-600 dark:text-gray-300 mb-8">
                Inscreva-se para receber notificações sobre novos eventos,
                workshops e oportunidades de networking da nossa cooperativa.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Para se inscrever em um evento, basta acessar a página do
                  evento específico e clicar no botão "Inscreva-se". Você será
                  direcionado para um formulário de inscrição que deve ser
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Não, a maioria dos eventos é aberta ao público, embora alguns
                  sejam exclusivos para colaboradores. As informações sobre o
                  público-alvo estão sempre disponíveis na descrição de cada
                  evento.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  início do evento. Para isso, acesse a área do participante com
                  seu e-mail e senha, e selecione a opção de cancelamento.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Alguns eventos são gratuitos, enquanto outros podem ter taxas
                  de inscrição. Colaboradores geralmente têm descontos ou
                  gratuidade em eventos pagos. As informações sobre valores
                  estão disponíveis na página de cada evento.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="container mx-auto px-4 mb-16">
        <div className="bg-green-600 dark:bg-green-700 rounded-xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Tem uma ideia para um evento, workshop ou treinamento? Colaboradores
            podem propor e organizar eventos com o apoio da nossa cooperativa.
          </p>
